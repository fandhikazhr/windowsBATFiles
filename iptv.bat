...
:switch-case-K-9
  ...
  echo 4. 9Volna                    24. CableHits                   44. EnerGeek                64. ITCTV               84. NCV
  echo 5. 30ASidewalks              25. CaptainTV                   45. EnerGeek2               65. JaihindTV           85. NegahTV
  ...
  :switch-case-E-43
    ...
    goto entertainment
  :switch-case-E-44
    mpv https://wifispeed.trapemn.tv:1936/infantil/energeek-1/playlist.m3u8
    echo Stop Playing
    pause
    cls
    goto entertainment
  :switch-case-E-45
    mpv https://wifispeed.trapemn.tv:1936/infantil/energeek-2/playlist.m3u8
    echo Stop Playing
    pause
    cls
    goto entertainment
  ...
  :switch-case-E-47
    ...
    goto entertainment
  :switch-case-E-48
    mpv https://dai2.xumo.com/amagi_hls_data_xumo1212A-electricnow/CDN/master.m3u8
    echo Stop Playing
    pause
    cls
    goto entertainment
...
:switch-case-K-10
  ...
  :switch-case-F-15
    ...
    goto family
  :switch-case-F-16
    mpv https://zabava-htlive.cdn.ngenix.net/hls/CH_STSLOVE/variant.m3u8
    echo Stop Playing
    pause
    cls
    goto family
...
:switch-case-K-11
  ...
  :switch-case-R-4
    ...
    goto kids
  :switch-case-R-5
    mpv http://ott-cdn.ucom.am/s46/index.m3u8
    echo Stop Playing
    pause
    cls
    goto kids
  :switch-case-R-6
    mpv https://livecdn.fptplay.net/hda3/babytvhd_vhls.smil/chunklist.m3u8
    echo Stop Playing
    pause
    cls
    goto kids
  :switch-case-R-7
    mpv https://dai2.xumo.com/amagi_hls_data_xumo1212A-redboxbatterypop/CDN/playlist.m3u8
    echo Stop Playing
    pause
    cls
    goto kids
